...
touch "${day_num}/results/example-input-result.pt1"
# touch "${day_num}/results/example-input-result.pt2"
touch "${day_num}/results/real-input-result.pt1"
# touch "${day_num}/results/real-input-result.pt2"
