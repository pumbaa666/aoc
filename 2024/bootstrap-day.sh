...
touch "${day_num}/results/example-input-results.pt1"
touch "${day_num}/results/example-input-results.pt2"
touch "${day_num}/results/real-input-results.pt1"
touch "${day_num}/results/real-input-results.pt2"
