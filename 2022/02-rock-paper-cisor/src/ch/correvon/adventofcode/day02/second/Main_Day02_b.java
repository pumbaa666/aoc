...
public class Main_Day02_b
{
	...
	public static void main(String[] args)
	{
		...
		// Mon score final : 10398
	}

	private static InputStream getFileStream(String fileName)
	{
		InputStream inputStream = Main_Day02_b.class.getResourceAsStream(fileName);
		if(inputStream == null)
	...
	private static List<Round> parseFile(InputStream inputStream)
	{
		...
		try (BufferedReader br = new BufferedReader(new InputStreamReader(inputStream)))
		{
			...
			while((line = br.readLine()) != null)
			{
				...
				Round round = new Round(Hand.parseEnum(roundArray[0]), RoundResult.parseEnum(roundArray[1]));
				rounds.add(round);
				lineNum++;
			}
		}
